...
var connectionString = builder.Configuration.GetConnectionString("GeekShoppingPaymentCs");
...
// builder.Services.AddSingleton( new PaymentRepository(dbContextBuilder.Options));
